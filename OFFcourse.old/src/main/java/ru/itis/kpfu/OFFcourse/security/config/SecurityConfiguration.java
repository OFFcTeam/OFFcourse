package ru.itis.kpfu.OFFcourse.security.config;
...
import ru.itits.restapi.security.filters.TokenAuthenticationFilter;
import ru.itits.restapi.security.providers.TokenAuthenticationProvider;
...
@ComponentScan("ru.itits.restapi") // говорим, чтобы искал все компоненты в наших пакетах
